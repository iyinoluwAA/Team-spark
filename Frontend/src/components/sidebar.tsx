...
export function Sidebar() {
	...
	return (
		<div className="hidden md:flex h-full w-[256px] flex-none flex-col items-center gap-3 bg-background px-3 pt-4 pb-6 shadow-[inset_-1px_0px_0px_0px_var(--border)]">
			...
			<div className="mt-auto flex items-center gap-2 text-[13px] leading-[16px] text-muted-foreground">
				<p>© 2025 EmotiChat</p>
